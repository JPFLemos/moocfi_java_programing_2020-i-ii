    ...
    public void start(Stage stage) {
        ...
        while (yCoordinate < height) {
            ...
            while (xCoordinate < width) {
                ...
                if (yCoordinate % 2 == 0 && xCoordinate % 2 == 0) {
                    imageWriter.setColor(xCoordinate/2, yCoordinate/2, newColor);
                    imageWriter.setColor((width + xCoordinate)/2, yCoordinate/2, newColor);
                    imageWriter.setColor(xCoordinate/2, (yCoordinate + height)/2, newColor);
                    imageWriter.setColor((width + xCoordinate)/2, (yCoordinate + height)/2, newColor);
                }
