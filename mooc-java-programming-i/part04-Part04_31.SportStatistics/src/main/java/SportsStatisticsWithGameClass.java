...
public class SportsStatisticsWithGameClass {
    ...
    public static void main (String[] args) {
        ...
        //Counting and storing the games of a specific team into an arraylist
        ArrayList<Game> gamesOfATeam = new ArrayList<>();
        for (Game game : games) {
          if  (teamName.equalsIgnoreCase(game.getHomeTeam()) || teamName.equalsIgnoreCase(game.getOpponent())) {
